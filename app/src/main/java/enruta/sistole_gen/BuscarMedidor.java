...
public class BuscarMedidor extends FragmentActivity implements TabListener {
	...
	final static int CON_ANOMALIA=3;
	final static int CON_SOLO_LECTURA=4;
	int ii_lastSelectedTab=0;
	
	boolean seSelecciono=false;
	
	private int[] tabs ={ R.string.lbl_medidor,R.string.lbl_direccion, R.string.lbl_numero};
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new BuscarMedidorTabsPagerAdapter(getSupportFragmentManager(), globales.remplazarDireccionPorCalles, globales);

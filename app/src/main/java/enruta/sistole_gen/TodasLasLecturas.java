...
public class TodasLasLecturas {
	...
	//Determina el orden que deber? tener la siguiente lectura
...
//	 }
	...
	/**
	 * Maneja el orden que tendr? la lectura
	 * @return
	 */
	...
	public void forzarLecturas(){
		...
		cv_params.put("anomalia", "AN888");
		cv_params.put("intentos", "00");
		cv_params.put("sospechosa", "00");
...
//		
	...
	/**
	 * Esta funcion regresa todas los edificios existentes en el sistema de colombia
	 * @param tipo Tipo de filtro, Se encuentran estaticamente en esta clase y pueden ser las siguientes:
	 * 0 - No leidas
	 * 1 - Leidas
	 * 2 - Todas las lecturas
	 ...
	 * 
	 */
	public Vector <String> getTodasLosEdificios(int tipo, String filtro){
		openDatabase();
		Vector <String> lvs_vector = new Vector <String>();
		Cursor c;

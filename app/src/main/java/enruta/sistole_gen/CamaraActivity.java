                    ...
                    public void onClick(View v) {
                        ...
                        if (!otraFoto && mCamera != null) {
                            try {
                                ...
                                Toast.makeText(CamaraActivity.this, "Hubo un error al abrir la cámara. Cierre y abra la aplicación", Toast.LENGTH_LONG);
                                finish();
                            }
                        } else {
                            iniciaCamara();
...
//    	ls_nombre+= "_" + is_terminacion +".jpg";
    ...
    Camera.ErrorCallback mCameraErrorCallback = new Camera.ErrorCallback() {
        @Override

    ...
    protected void getUltLect() {
        ...
        if (preguntaSiBorraDatos /*&& !globales.bModificar*/) {
            if (!globales.tll.getLecturaActual().getAnomaliasCapturadas().equals("") &&
                ...
                //Si ingres﷿ datos, estoy en modo captura y  me estoy moviendo deberia preguntar
...
//			is_mensaje_direccion= getString(R.string.msj_tdl_no_mas_lecturas_despues);
    ...
    protected void mensajeOK(String ls_mensaje) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
...
//			is_mensaje_direccion= getString(R.string.msj_tdl_no_mas_lecturas_antes);
    ...
    protected void mandarAImprimir(Lectura llec_lectura) throws Exception {
    ...
    String getUnicomDelEncabezado() throws Exception {
        openDatabase();
        Cursor c;
    ...
    public void getImpresora()  {
        try {
            ...
            strMACImpresora = Utils.getString(c, "value", "");
    ...
    public boolean validaCampoDeConfig(Cursor c, String ls_mensaje) throws  Exception {
        String ls_valor;
        if (c.getCount() == 0) {
            ...
            ls_valor = Utils.getString(c, "value", "");
            if (ls_valor.equals("")) {
...
//			    Log.i(TAG, String.valueOf(Satellites) + " Used In Last Fix ("+SatellitesInFix+")"); 
        ...
        //Establecemos que cada 4 segundos y 1 metros de diferencia quiero las actualizaciones

        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 10000, 1, locationListener);
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER/*provider*/, 10000, 1, locationListener);

//		locationManager.addNmeaListener(new NmeaListener() {
//            public void onNmeaReceived(long timestamp, String nmea) {
//
//            	String[] arreglo = nmea.split(",");
//            	
//              globales.fix=arreglo[6];
//
//            }});
...
//		final EditText et_archivocarga= (EditText) view.findViewById(R.id.et_archivocarga);
    ...
    protected abstract void regresaDeMensaje(MensajeEspecial me, int respuesta) throws Exception;

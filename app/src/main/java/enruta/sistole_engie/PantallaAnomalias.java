...
//        }
    ...
    public void mandarAnomalia() {
        ...
        if (globales.convertirAnomalias && globales.respetarLongitudDeEntradaAnomalias)
            longAnomalia = this.getResources().getInteger(R.integer.ANOM_LONG_CONV);
        else
            longAnomalia = globales.longitudCodigoAnomalia;


        String ls_anomalia = Main.rellenaString(is_anomaliaSelec, "", longAnomalia, true);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case TomaDeLecturas.COMENTARIOS:
                procesarComentarios(data, resultCode, page);
                break;
            case TomaDeLecturas.INPUT_CAMPOS_GENERICO:
                procesarInputCamposGenerico(data, resultCode, page);
                break;
        }
    }
...
//				//La ultima pestaña son todas, no se actualiza
    ...
    /*
        Procesa el resultCode = COMENTARIOS
    */

    private void procesarComentarios(final Intent data, final int resultCode, PantallaAnomaliasFragment page) {
        Bundle bu_params;
...
//				this.finish();
    ...
    /*
        Procesa el resultCode = INPUT_CAMPOS_GENERICO
    */

    private void procesarInputCamposGenerico(final Intent data, final int resultCode, PantallaAnomaliasFragment page) {
        Bundle bu_params;
